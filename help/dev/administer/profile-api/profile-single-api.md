...
* [!UICONTROL 单个配置文件更新API]被限制为在任何滚动的24小时内执行100万次更新。
...
* [!UICONTROL 单个配置文件更新API]是服务器到服务器API，设计为在网页中工作。 若要从您的网页中更新访客资料，您可以使用[trackEvent()](/help/dev/implement/client-side/atjs/atjs-functions/adobe-target-trackevent.md)函数或[交付API](/help/dev/implement/delivery-api/overview.md)。
...
[!UICONTROL 单个配置文件更新API]仅用于更新。 如果未找到任何内容，则不会创建配置文件。

...
有关详细信息，请参阅&#x200B;*Edge Network Server API文档*&#x200B;中的[Edge Server API概述](https://experienceleague.adobe.com/docs/experience-platform/edge-network-server-api/overview.html){target=_blank}。

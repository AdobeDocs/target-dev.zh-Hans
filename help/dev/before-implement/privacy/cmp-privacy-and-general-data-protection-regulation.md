...
Adobe Experience Cloud为数据控制方提供了为GDPR做好准备的API，允许他们完成以下任务：
...
包括Target在内的所有Experience Cloud解决方案中的GDPR和CCPA请求均通过集中Adobe API进行，后者目前称为GDPR API。 然后，API跨数据控制方的Experience Cloud解决方案套件完成请求。

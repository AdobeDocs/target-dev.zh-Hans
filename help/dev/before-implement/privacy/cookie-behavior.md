...
>[!NOTE]
>
>有关[!DNL Target]使用的其他Cookie的详细信息，请参阅&#x200B;*Experience Cloud中央界面组件指南*&#x200B;中的[[!DNL Adobe Target] Cookie](https://experienceleague.adobe.com/docs/core-services/interface/administration/ec-cookies/cookies-target.html?lang=zh-Hans){target=_blank}。
>

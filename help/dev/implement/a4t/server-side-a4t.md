...
[!DNL Adobe Experience Platform Web SDK]允许您在[!UICONTROL Adobe Analytics Edge Network]上实施[!UICONTROL Experience Platform for Target] (A4T)功能。 启用服务器端日志记录后，通过Edge Network发送的所有[!DNL Analytics]点击在服务器端都通过[!DNL Target]详细信息增加，而无需经历点击拼合过程。

...
了解如何使用[!DNL Adobe Experience Platform Mobile SDK]在移动应用程序中实施[!DNL Adobe Experience Cloud]应用程序。 有关详细信息，请参阅[!DNL Experience Platform] *移动应用程序教程*&#x200B;中的[在移动应用程序中实施Adobe Experience Cloud教程](https://experienceleague.adobe.com/docs/platform-learn/implement-mobile-sdk/overview.html){target=_blank}。

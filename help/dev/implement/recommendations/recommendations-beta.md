...
发生购买事件时，传递购买项目的身份。 请参阅[如何部署at.js >在不使用标签管理器](../client-side/atjs/how-to-deployatjs/implement-target-without-a-tag-manager.md)的情况下实施[!UICONTROL Target]文章中的[跟踪转化](../client-side/atjs/how-to-deployatjs/implement-target-without-a-tag-manager.md#track-conversions)。
...
要访问&#x200B;**[!UICONTROL 推荐设置]**&#x200B;选项，请在[!DNL Adobe Experience Cloud]中打开[!DNL Target]，然后单击&#x200B;**[!UICONTROL 管理]** > **[!UICONTROL 推荐]**。

![推荐设置页面](/help/dev/implement/recommendations/assets/recs-settings-new.png)

配置以下选项：

### [!UICONTROL 推荐API令牌]

[!UICONTROL 推荐API令牌]部分中有以下选项可用：

#### [!UICONTROL 客户端代码]

[!DNL Target] [!UICONTROL 客户端代码]。

如果您不知道您的[!UICONTROL 客户端代码]，请在[!DNL Target]用户界面中单击&#x200B;**[!UICONTROL 管理]** > **[!UICONTROL 实施]**。 [!UICONTROL 客户端代码]显示在[!UICONTROL 帐户详细信息]部分。
...
[!UICONTROL 产品目录]部分中有以下选项：

#### [!UICONTROL 默认主机组]

选择您的默认主机组。

主机组可用于为不同用途而分隔目录中的可用项。 例如，您可以将主机组用于“开发和生产”环境、不同的品牌或不同的地理位置。 默认情况下，“目录搜索”、“收藏集”和“排除项”中的预览结果均基于默认的主机组。 （也可以使用“环境”筛选器选择其他主机组来预览结果。） 默认情况下，新添加的项目在所有主机组中都可用，除非在创建或更新项目时指定了环境ID。 交付的“推荐”取决于请求中指定的主机组。

如果您看不到产品，请确保您使用的是正确的主机组。 例如，如果您将推荐设置为使用测试环境并将您的主机组设置为“测试”，则您可能需要在测试环境中重新创建收藏集，之后才会显示产品。 要查看每个环境中提供了哪些产品，请在每个环境中使用“目录搜索”。 您还可以预览选定环境（主机组）的[!UICONTROL 推荐]收藏集和排除项的内容。

>[!NOTE]
>
>更改选定的环境后，必须单击&#x200B;**[!UICONTROL 搜索]**&#x200B;以更新返回的结果。

**[!UICONTROL 环境]**&#x200B;筛选器可从Target UI中的以下位置访问：

* 目录搜索（**[!UICONTROL 推荐]** > **[!UICONTROL 目录搜索]**）
* 收藏集（**[!UICONTROL 推荐]** > **[!UICONTROL 收藏集]**）
* 创建收藏集对话框（**[!UICONTROL 推荐]** > **[!UICONTROL 收藏集]** > **[!UICONTROL 创建收藏集]**）
* “更新收藏集”对话框（**[!UICONTROL 推荐]** > **[!UICONTROL 收藏集]** > **[!UICONTROL 编辑]**）
...
单击&#x200B;**[!UICONTROL 添加]**&#x200B;以创建新配置，指定配置名称，选择所需的配置文件属性，然后单击&#x200B;**[!UICONTROL 保存]**。

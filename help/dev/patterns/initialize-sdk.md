...
![初始化SDK图](/help/dev/patterns/assets/diagram-initiaze-sdk.png){width="600" zoomable="yes"}
...
![设置客户ID](/help/dev/patterns/assets/set-customer-id.png){width="100" zoomable="yes"}
...
![数据映射图](/help/dev/patterns/assets/data-mapping.png){width="100" zoomable="yes"}
...
![远程数据映射图](/help/dev/patterns/assets/remote-data-mapping.png){width="100" zoomable="yes"}
